...
// Client half: the data arrives already fetched from the server component, so
// this only owns the approve/merge interaction.
export default function ExperimentDetail({ id, data }: { id: string; data: Detail }) {
